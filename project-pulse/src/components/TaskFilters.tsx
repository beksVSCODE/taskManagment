  ...
  return (
    <div className="space-y-2.5">
      <div className="flex items-center gap-2.5 flex-wrap">
        {/* Search */}
        <div className="relative w-full md:flex-1 md:min-w-[220px] md:max-w-xs">
        ...
        {/* Sort direction + Advanced + Reset — desktop only */}
      ...
      {showAdvanced && (
        <div className="hidden md:flex items-center gap-3 flex-wrap bg-muted/30 rounded-lg px-3 py-2.5">
